...
``qibo.set_backend("nexus", ...)`` must import this package, locate
``MetaBackend.load(**kwargs)``, and yield a :class:`NexusClientBackend`.
"""

from qibo.backends import get_backend, set_backend

import nexus.backend as nexus_mod
from nexus import MetaBackend, NexusClientBackend
